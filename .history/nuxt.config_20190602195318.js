module.exports = {
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Hexly' }
    ],
    link: [
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css?family=Pacifico|Poppins:300,400,500,600,700'
      },
    ...
    {rel: 'stylesheet' , href: 'css/style.css'},</link},
    ]
  }
}
